...
export default function AdminStats() {
  ...
  if (isLoading)
    return <p className="loading-message">Chargement des statistiques...</p>;
  if (error || !data)
    return (
      <p className="error-message">Impossible de charger les statistiques.</p>
    );
  ...
  return (
    <div className="admin-stats">
      <Title title="Vue d'ensemble" variant="h2" />
